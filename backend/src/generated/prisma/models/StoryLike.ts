...
export type StoryLikeOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"storyId" | "userId" | "createdAt", ExtArgs["result"]["storyLike"]>
...
export interface StoryLikeDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const storyLikeWithStoryIdOnly = await prisma.storyLike.findMany({ select: { storyId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many StoryLikes and only return the `storyId`
   * const storyLikeWithStoryIdOnly = await prisma.storyLike.createManyAndReturn({
   *   select: { storyId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more StoryLikes and only return the `storyId`
   * const storyLikeWithStoryIdOnly = await prisma.storyLike.updateManyAndReturn({
   *   select: { storyId: true },
   *   where: {
   *     // ... provide filter here
   *   },
